...
public class Product {
    ...
    private final IntegerProperty prodStock;
    ...
    public Product() {
        ...
        prodStock = new SimpleIntegerProperty();
    ...
    public void setProductStock(int inStock) {
        this.prodStock.set(inStock);
    }
